...
export const postResourceApi = async (data: Partial<ResourceData>): Promise<IResponse> => {
  const res = await request.post({ url: '/api/sys/resources', data })
  return res && res.data
}

export const putResourceApi = async (data: Partial<ResourceData>): Promise<IResponse> => {
  const res = await request.put({ url: '/api/sys/resources', data })
  return res && res.data
}

export const deleteResourceApi = async (id: Partial<ResourceData>): Promise<IResponse> => {
  const res = await request.delete({ url: `/api/sys/resources/${id}` })
  return res && res.data
}

export const putResourceDisableApi = async (id: Partial<ResourceData>): Promise<IResponse> => {
  const res = await request.put({ url: `/api/sys/resources/${id}/disable` })
  return res && res.data
}

export const putResourceEnableApi = async (id: Partial<ResourceData>): Promise<IResponse> => {
