...
export const postUserApi = async (data: Partial<UserData>): Promise<IResponse> => {
  const res = await request.post({ url: '/api/sys/users', data })
  return res && res.data
}

export const putUserApi = async (data: Partial<UserData>): Promise<IResponse> => {
  const res = await request.put({ url: '/api/sys/users', data })
  return res && res.data
}

export const deleteUserApi = async (id: Partial<UserData>): Promise<IResponse> => {
  const res = await request.delete({ url: `/api/sys/users/${id}` })
  return res && res.data
}

export const putUserDisableApi = async (id: Partial<UserData>): Promise<IResponse> => {
  const res = await request.put({ url: `/api/sys/users/${id}/disable` })
  return res && res.data
}

export const putUserEnableApi = async (id: Partial<UserData>): Promise<IResponse> => {
  const res = await request.put({ url: `/api/sys/users/${id}/enable` })
  return res && res.data
}

export const putPasswordApi = async (data: Partial<UserData>): Promise<IResponse> => {
