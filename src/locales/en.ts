export default {
  ...
  router: {
    ...
    epartment: 'Epartment',
    gardenDevice: 'Garden device',
    energySensor: 'Eneryg sensor',
    energyStatistic: 'Energy statistic',
    queueManager: 'Queue manager',
    queueTerminal: 'Queue terminal',
  ...
  systemManager: {
    ...
    parentResourceName: 'Parent resource name',
    ...
    roleName: 'Role name',
    roleCode: 'Role code',
    roleDecription: 'Role decription',
    roleType: 'Role type',
